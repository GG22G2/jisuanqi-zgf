    ...
    (function (example) {
        class App {
            ...
            static defaultTask(officialGameData, myGameData, rewardAndCount) {
                ...
                sexReward = [0, 0.5]
                const inference = new com.example.calculation.GodInference(reward, sexReward, materialCount, officialGameData, myGameData);
            ...
            class GodInference {
                ...
                calSecondStage(topPlayCher) {
                    ...
                    for (let i = 0; i < 3; i++) {
                        ...
                        console.log(name1 + " " + count1 + ";" + name2 + " " + count2 + ";" + name3 + " " + count3);
                        chefs.push({
                            chef: ownChef.name,
                            equip: "",
                            recipes: [
                                {recipe: name1,
                                    count: count1}, {recipe: name2,
                                    count: count2},
                                {recipe: name3,
                                    count: count3}
                            ]
            ...
            (function (TempCalCache) {
                class builder {
                    ...
                    init(ownChefs, ownRecipes, ownEquips, officialGameData, globalAddtion, reward, sexReward) {
                        ...
                        this.reward = reward;
                        this.sexReward = sexReward;
                        this.tempCalCache = new com.example.calculation.TempCalCache(ownChefs.length, ownRecipes.length);
                    }
